...
import com.example.tictactoegame.session.service.GameSimulation;
import com.example.tictactoegame.session.service.GameSimulationRandom;
...
public class SimulationConfig {
  ...
  public GameSimulation gameSimulation(SessionService sessionService, GameEngineGateway gameEngineGateway) {
    return new GameSimulationRandom(sessionService, gameEngineGateway);
  }
}
